...
class discount extends Model
{
    ...
    public function shamsi(): Attribute
    {
        return Attribute::make(
            get: fn () => Jalalian::fromDateTime($this->updated_at)->format('l, y/m/d H:i')
        );
    }
    public function startShamsi() :Attribute
    {
        return Attribute::make(
            get: fn () => Jalalian::fromDateTime($this->start_date)->format('l, y/m/d H:i')
        );
    ...
    {
        return Attribute::make(
            get: fn () => Jalalian::fromDateTime($this->end_date)->format('l, y/m/d H:i')
        );

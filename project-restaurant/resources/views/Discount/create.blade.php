...
{{--	<link rel="stylesheet" href="css/cssDiscount/style.css">--}}
...
<div class="container">
    <div class="form">
        <form action="{{route('discount.store')}}" method="post" enctype="multipart/form-data" >
            @csrf
            <div class="name">
                <input type="text" name="name" placeholder="Enter Name Food">
            </div>
            ...
            <div class="endDate">
                <input type="date" name="end_date" placeholder="Enter EndDate">
            </div>
            <button type="submit" class="btn btn-dark">ایجاد تخفیف</button>
        </form>
    </div>
</div>
